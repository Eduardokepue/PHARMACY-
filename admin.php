...
<?php include('navfixed.php');?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Pharmcare Pharmacy</center></font>
<div id="mainmain">



<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br> Sales</a>
<a href="staff.php"><i class="icon-group icon-2x"></i><br> users</a>                 
...
<a href="supplier.php"><i class="icon-group icon-2x"></i><br> Manufacturer</a>     
