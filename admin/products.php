...
<a  href="admin.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			require_once('connect_db.php');
				$result = $dbh->prepare("SELECT * FROM products ORDER BY qty_sold DESC");
				$result->execute();
			...
			Total Number of Products:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo htmlentities( $rowcount);?>]</font>
			</div>
